...
test('invalid first RPC fails closed before route evaluation',async()=>{
 await assert.rejects(()=>quoteAndEvaluateV2RoundTrip({
  ...
  route:{chainId:1,loanAsset:'0x0000000000000000000000000000000000000001',loanAmount:1n,loanAmountUsd:1,flashLoanFeeUsd:0,protocolFeeUsd:0,gasUsd:0,slippageUsd:0,finalAmountUsd:1},minNetProfitUsd:0.1,safetyReserveUsd:0
 }),/RPC_NOT_CONFIGURED/)
})
